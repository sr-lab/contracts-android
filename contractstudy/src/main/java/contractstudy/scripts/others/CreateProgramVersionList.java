...
/**
 * Script to create a simple text file consisting of all zips containing program versions. The
 * purpose of such a file is to manually edit the order of versions.
 *
