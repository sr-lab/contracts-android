...
/**
 * Task to collect inconsistent zips. See issue #42 for motivation. We look for zips with multiple
 * versions of the same file inside, there is a known case where this is caused by inconsistent meta
 * data. Findings are reported on the console.
 *
