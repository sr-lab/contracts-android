...
/**
 * Creates a blacklist of program versions (filenames) which cannot be reliably compared in
 * evolution study due to version qualifiers with unknown semantics.
 *
 * @author premek brada
