    ...
    Map<DiffResult, File> DETAIL_LOGS = new HashMap<DiffResult, File>() {
      {
        put(DiffResult.POSTCONDITION_REMOVED,
          new File(RESULTS_FOLDER, "postconditions_hierarchy_removed.log"));
        put(DiffResult.PRECONDITION_ADDED,
          new File(RESULTS_FOLDER, "preconditions_hierarchy_added.log"));
      }
    };
    // reset logs
