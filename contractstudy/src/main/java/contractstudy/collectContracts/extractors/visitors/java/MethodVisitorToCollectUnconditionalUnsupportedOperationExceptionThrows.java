...
public class MethodVisitorToCollectUnconditionalUnsupportedOperationExceptionThrows extends
  ...
  public void visit(ThrowStmt n, Object arg) {
    ...
    if (excTypeName.endsWith(UnsupportedOperationException.class.getSimpleName())
      && n.getExpression() instanceof ObjectCreationExpr && (
      n.getParentNode().get() instanceof IfStmt || (n.getParentNode().get() instanceof BlockStmt
        && n.getParentNode().get().getParentNode().get() instanceof MethodDeclaration))) { // JFF
