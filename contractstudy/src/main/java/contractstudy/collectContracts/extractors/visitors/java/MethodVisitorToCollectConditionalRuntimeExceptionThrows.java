package contractstudy.collectContracts.extractors.visitors.java;
...
public class MethodVisitorToCollectConditionalRuntimeExceptionThrows extends AbstractMethodVisitor {
  ...
  public void visit(ThrowStmt n, Object arg) {
    ...
    if (n.getExpression() instanceof ObjectCreationExpr && (
      n.getParentNode().get() instanceof IfStmt
        || (n.getParentNode().get() instanceof BlockStmt && n.getParentNode().get().getParentNode()
        .get() instanceof IfStmt))) {

      IfStmt condNode =
        n.getParentNode().get() instanceof BlockStmt ? (IfStmt) n.getParentNode().get()
          .getParentNode().get()
