...
public class ContractElement {
  ...
  public static ContractElement fromJSON(JSONObject json) {
    ...
    mc.setProgramVersion(
      ProgramVersion.getOrCreate(json.getString("name"), json.getString("version")));
  ...
  public String toString() {
    return "Constraint Program Version " + programVersion + " CU  " + cuName + " [kind=" + kind
      + ", condition=\"" + condition + "\""
