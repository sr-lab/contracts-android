...
import android.media.MediaCodec.CryptoException;
//import android.media.MediaCodec.IncompatibleWithBlockModelException;
//import android.media.MediaCodec.IncompatibleWithBlockModelException;
...
//import com.google.android.things.lowpan.OperationCanceledException;
import android.os.ParcelFormatException;
//import androidx.core.net.ParseException;
//import android.view.inspector.PropertyMapper.PropertyConflictException;
//import android.view.inspector.PropertyMapper.PropertyConflictException;
...
import android.graphics.SurfaceTexture.OutOfResourcesException;
import android.graphics.SurfaceTexture.OutOfResourcesException;
...
public class MethodVisitorToCollectConditionalRuntimeExceptionThrows extends AbstractMethodVisitor {
	...
	String x = "DateTimeParseException";

	public MethodVisitorToCollectConditionalRuntimeExceptionThrows(ExtractionListener<ContractElement> consumer,
	...
	private static ConstraintType getPreconditionTypeForExceptionName(String excName) {
		// note that this can yield false results of classes with this name are imported
		...
		else if (excName.endsWith(CryptoException.class.getSimpleName()))
		...
		else if (excName.endsWith(ActionException.class.getSimpleName()))
		...
		else if (excName.endsWith(NotFoundException.class.getSimpleName()))
		...
		else if (excName.endsWith(OutOfResourcesException.class.getSimpleName()))
		...
		else if (excName.endsWith(BadSurfaceTypeException.class.getSimpleName()))
		...
		else if (excName.endsWith(BadTokenException.class.getSimpleName()))
		...
		else if (excName.endsWith(UnavailableException.class.getSimpleName()))
