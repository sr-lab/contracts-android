...
/**
 * Special rule where a nullable annotation is removed. This is seen as a minor, uncritical change.
 *
    ...
    if (constraints1.size() > constraints2.size()) {
      ...
      for (ContractElement c2 : constraints2) {
        ...
        for (ContractElement c1 : constraints1) {
          found = found || Utils.unchanged(c1, c2, true);
        }
