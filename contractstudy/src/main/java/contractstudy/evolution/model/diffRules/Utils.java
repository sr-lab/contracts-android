...
public class Utils {
  ...
  public static List<ContractElement> filter(List<ContractElement> contractElements,
    Predicate<ContractElement> condition) {
   ...
   * @return
   */
  public static boolean unchanged(ContractElement o1, ContractElement o2,
    boolean ignoreAdditionalInfoField) {
  ...
  /**
   * Return true if the input version cannot be sorted due to crazy version coding.
   *
