...
public class TestHierarchy {
  ...
  public static final File APP_DATA_FOLDER = new File(
    "src/test/java/contractstudy/hierarchy/testdata/simple/");

  public static final File TEST_DEPSA_DATA_FOLDER = new File(
    "src/test/java/contractstudy/hierarchy/testdata/depsa/");

  public static final File TEST_DEPSB_DATA_FOLDER = new File(
    "src/test/java/contractstudy/hierarchy/testdata/depsb/");

  private final ProjectVersionHierarchyExtractor extractor = new ProjectVersionHierarchyExtractor();
  ...
  public void testClassAndInterface() throws Exception {
    ...
    ProgramVersion depa = ProgramVersion.getOrCreate("depa", "1.0")
      .withFile(TEST_DEPSA_DATA_FOLDER);
    ProgramVersion depb = ProgramVersion.getOrCreate("depb", "1.0")
      .withFile(TEST_DEPSB_DATA_FOLDER);
