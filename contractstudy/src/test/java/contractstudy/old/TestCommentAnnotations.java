...
public class TestCommentAnnotations {
  ...
  public static final File TEST_DATA_FOLDER = new File(
    "src/test/java/test/contractstudy/testdata/commentannotations/");

  private boolean containsSomePattern(String className) throws Exception {
    String src = Files.toString(new File(TEST_DATA_FOLDER, className + ".java"),
