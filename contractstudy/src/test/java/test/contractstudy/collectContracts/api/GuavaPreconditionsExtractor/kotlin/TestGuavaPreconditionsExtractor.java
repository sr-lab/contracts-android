package test.contractstudy.collectContracts.api.GuavaPreconditionsExtractor.kotlin;
...
public class TestGuavaPreconditionsExtractor {
  ...
  private static final File TEST_DATA_FOLDER = new File(
    Utils.getBasePathTestFolder() + "collectContracts/api/GuavaPreconditionsExtractor/kotlin/testData");
