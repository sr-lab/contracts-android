package test.contractstudy.collectContracts.api.CommonsValidateExtractor.CommonsValidate3Extractor.java;
...
public class TestCommonsValidate3EnumExtractor {
  ...
  private static final File TEST_DATA_FOLDER = new File(Utils.getBasePathTestFolder()
    + "collectContracts/api/CommonsValidateExtractor/CommonsValidate3Extractor/java/testData");
