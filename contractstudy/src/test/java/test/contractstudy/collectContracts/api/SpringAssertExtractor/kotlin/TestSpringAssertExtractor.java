package test.contractstudy.collectContracts.api.SpringAssertExtractor.kotlin;
...
public class TestSpringAssertExtractor {
  ...
  private static final File TEST_DATA_FOLDER = new File(
    Utils.getBasePathTestFolder() + "collectContracts/api/SpringAssertExtractor/kotlin/testData");
