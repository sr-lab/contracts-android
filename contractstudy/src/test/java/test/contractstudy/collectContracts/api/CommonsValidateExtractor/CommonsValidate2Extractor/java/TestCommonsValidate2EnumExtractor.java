package test.contractstudy.collectContracts.api.CommonsValidateExtractor.CommonsValidate2Extractor.java;
...
public class TestCommonsValidate2EnumExtractor {
  ...
  private static final File TEST_DATA_FOLDER = new File(Utils.getBasePathTestFolder()
    + "collectContracts/api/CommonsValidateExtractor/CommonsValidate2Extractor/java/testData");

  private static Stream<Arguments> generatorCommonsValidate2() {
    return Stream.of(
      Arguments.of(ConstraintType.CommonsLangNotNull, "MultipleCommonsValidate2.java", 2),
      Arguments.of(ConstraintType.CommonsLangNotEmpty, "MultipleCommonsValidate2.java", 1),
      Arguments.of(ConstraintType.CommonsLangIsTrue, "MultipleCommonsValidate2.java", 1),
      Arguments.of(ConstraintType.CommonsLang2AllElementsOfType, "MultipleCommonsValidate2.java",
        3));
  }

  private static Stream<Arguments> generatorCommonsValidate2WithStaticImport() {
    return Stream.of(
      Arguments.of(ConstraintType.CommonsLangNotNull, "MultipleCommonsValidate2StaticImport.java",
        1),
      Arguments.of(ConstraintType.CommonsLangNotEmpty, "MultipleCommonsValidate2StaticImport.java",
        1),
      Arguments.of(ConstraintType.CommonsLangIsTrue, "MultipleCommonsValidate2StaticImport.java",
        1));
  }

  private static Stream<Arguments> generatorCommonsValidate2WithStaticWildCardImport() {
    return Stream.of(
      Arguments.of(ConstraintType.CommonsLangNotNull, "MultipleCommonsValidate2StaticImport.java",
        1),
      Arguments.of(ConstraintType.CommonsLangNotEmpty, "MultipleCommonsValidate2StaticImport.java",
  ...
  @ParameterizedTest
  @MethodSource("generatorCommonsValidate2WithStaticWildCardImport")
