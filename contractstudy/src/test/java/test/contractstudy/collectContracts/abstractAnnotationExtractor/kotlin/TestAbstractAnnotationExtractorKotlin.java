package test.contractstudy.collectContracts.abstractAnnotationExtractor.kotlin;
...
public class TestAbstractAnnotationExtractorKotlin {
  ...
  private static final File TEST_DATA_FOLDER = new File(
    Utils.getBasePathTestFolder() + "collectContracts/abstractAnnotationExtractor/kotlin/testData");
