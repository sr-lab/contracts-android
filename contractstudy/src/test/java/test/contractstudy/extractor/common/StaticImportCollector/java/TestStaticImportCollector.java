package test.contractstudy.extractor.common.StaticImportCollector.java;
...
public class TestStaticImportCollector {
  ...
  private static final File TEST_DATA_FOLDER = new File(
    Utils.getBasePathTestFolder() + "extractor/common/StaticImportCollector/java/testData");

  private static Stream<Arguments> generateParameters() {
    return Stream.of(
      Arguments.of(StaticImportState.NONE, "StaticImportNone.java", "none", "none"),
      Arguments.of(StaticImportState.CLASS, "StaticImportClass.java", "java.util.List", "java.util.List"),
      Arguments.of(StaticImportState.ALL_STATIC, "StaticImportAllStatic.java", "java.lang.Math", "java.lang.Math.PI"),
      Arguments.of(StaticImportState.ALL_STATIC, "StaticImportAllStatic.java", "java.lang.System", "java.lang.System"),
      Arguments.of(StaticImportState.SOME_STATIC, "StaticImportSomeStatic.java", "java.lang.System.out", "java.lang.System.out"));
  }
  ...
  public void testStaticImportCollector_withDifferentFiles_expectDifferentStates(
    ...
    //when
    StaticImportCollector importsCollector = new StaticImportCollector(annotationPackageName, targetQClassName);
