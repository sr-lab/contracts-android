package test.contractstudy.extractor.api.CommonsValidateExtractor.CommonsValidate2Extractor.kotlin;
...
public class TestCommonsValidate2EnumExtractor {
  ...
  private static final File TEST_DATA_FOLDER = new File(Utils.getBasePathTestFolder()
    + "extractor/api/CommonsValidateExtractor/CommonsValidate2Extractor/kotlin/testData");
