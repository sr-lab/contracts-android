package test.contractstudy.extractor.api.CommonsValidateExtractor.CommonsValidate3Extractor.kotlin;
...
public class TestCommonsValidate3EnumExtractor {
  ...
  private static final File TEST_DATA_FOLDER = new File(Utils.getBasePathTestFolder()
    + "extractor/api/CommonsValidateExtractor/CommonsValidate3Extractor/kotlin/testData");
